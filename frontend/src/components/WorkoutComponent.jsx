...
export default function WorkoutComponent(props) {
  ...
  return (
    <div className="w-2/3 pb-3 my-8 rounded-md bg-slate-100 md:w-1/3">
      <Link to={`/profile/${props.workout.user}`}><div className="flex items-center justify-between w-full p-2 py-3 bg-slate-300 rounded-t-md">

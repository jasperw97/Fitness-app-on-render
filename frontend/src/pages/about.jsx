    ...
    <div className="relative overflow-x-hidden">
      ...
      <div className="flex flex-col-reverse items-center w-screen min-h-screen bg-white md:flex-row group">
        <div className="flex justify-center w-2/3 md:w-1/2">
          <div className="w-full md:w-2/3 pb-3 my-8 rounded-md bg-white border border-gray-400 md:group-hover:animate-bounce-twice md:translate-y-[25%]">
            <div className="flex items-center justify-between w-full p-2 py-3 bg-slate-100 rounded-t-md">
      ...
      <div className="flex flex-col items-center justify-center py-12 bg-gray-100">
        <h1 className="font-extralight">Contact Me: @jasper.l.wei97@gmail.com</h1>
        <div className="font-thin"><span className="underline hover:cursor-pointer" onClick={() => changeLanguage("en")}>English</span> <span className="underline hover:cursor-pointer" onClick={() => changeLanguage("zh")}>繁體中文</span></div>
